...
\begin{DoxyCompactList}\small\item\em Proc�dure lorsque le projectile agit avec unvaisseau. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Proc�dure lorsque le projectile agit avec unvaisseau. 
...
\hline
\end{DoxyParams}
Gestion du d�placement et de l\textquotesingle{}affichage 
